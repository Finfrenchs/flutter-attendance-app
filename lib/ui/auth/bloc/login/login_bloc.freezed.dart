...
mixin _$LoginState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(LoginResponseModel responseModel) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(LoginResponseModel responseModel)? loaded,
...
abstract class _Loaded implements LoginState {
  const factory _Loaded(final LoginResponseModel responseModel) = _$LoadedImpl;
