...
class CheckinResponseModel {
  ...
  factory CheckinResponseModel.fromJson(String str) =>
      CheckinResponseModel.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory CheckinResponseModel.fromMap(Map<String, dynamic> json) =>
      CheckinResponseModel(
