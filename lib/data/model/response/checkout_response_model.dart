...
class CheckOutResponseModel {
  ...
  factory CheckOutResponseModel.fromJson(String str) =>
      CheckOutResponseModel.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory CheckOutResponseModel.fromMap(Map<String, dynamic> json) =>
      CheckOutResponseModel(
